...
# coefficients hash will first hash on the Location ID, then the calibration ID and then the slope {a} or intercept {b}. Each row of Calibration table
# contains the curve information for a node, and modality:
